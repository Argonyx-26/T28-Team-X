...
DIAGNOSE_PHOTO = (
    ...
    "is itself a sum or product, put it in brackets, for example (3+1)/(4+4). "
...
DIAGNOSE_PHOTO_ANY = (
    ...
    "numerator or denominator is itself a sum or product, put it in brackets, for example (2+1)/(5+3). The first "
    "transcribed line must be the problem itself (for example 2/5 + 1/3); a roll number or name at the top is not a "
    "line of working, leave it out. "
...
READ_PAGE = (
    ...
    "product, put it in brackets, for example (3+1)/(4+4); join the lines with ' | '. The first line of each "
